...
function Modal() {
  return (
    <div
      id="modal-block"
      className="absolute top-0 w-full h-screen flex justify-center items-center overflow-hidden bg-slate-600/75"
    >
      <div
        id="modal-elt"
      ...
      >
        <XIcon className="w-6 h-6 absolute top-2 right-2 hover:cursor-pointer hover:scale-125 transition-all origin-center" />
